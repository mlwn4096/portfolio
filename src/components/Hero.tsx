...
export const Hero: React.FC = () => {
  return (
    <section className="relative overflow-hidden border-b-4 border-black bg-[#FFFDF5] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Badges Row - minimal, impactful */}
            <div className="flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-1.5 border-3 border-black bg-neo-secondary px-3 py-1 text-xs font-black uppercase tracking-widest text-black shadow-neo-sm -rotate-1">
            ...
            <div>
              <h1 className="font-display font-extrabold text-5xl sm:text-7xl md:text-8xl lg:text-8xl uppercase tracking-tighter leading-[0.9] text-black">
                MELWIN
                <span className="block text-stroke-black-3">
                  SANTHOSH
                </span>
              </h1>
            </div>
            ...
            {/* Descriptive Pitch */}
            <div className="border-4 border-black bg-white p-5 sm:p-6 shadow-neo max-w-2xl">
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                className="p-2.5 border-2 border-black bg-white shadow-neo-sm hover:bg-neo-secondary transition-colors"
              >
